...
LOCAL_MODULE := aic-bs9sx1a-ops-info.json

include $(BUILD_SYSTEM)/base_rules.mk

$(LOCAL_BUILT_MODULE):
	@mkdir -p $(dir $@)
	@./cann/ops/built-in/tbe/scripts/compile_tbe_info.sh $(product) bs9sx1a
	@echo $@
	@echo $(HOST_OUT_INTERMEDIATES)/$(notdir $@)
	@cp $(HOST_OUT_INTERMEDIATES)/$(notdir $@) $@
	@echo $(HOST_OUT_INTERMEDIATES)
...
LOCAL_INSTALLED_PATH :=  $(HOST_OUT_ROOT)/ops/built-in/op_impl/ai_core/tbe/impl
...
LOCAL_MODULE_CLASS := FOLDER
LOCAL_INSTALLED_PATH :=  $(HOST_OUT_ROOT)/ops/built-in/fusion_rules
include $(BUILD_HOST_PREBUILT)
